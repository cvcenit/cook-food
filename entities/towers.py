...
from utils import SCREEN_WIDTH, SCREEN_HEIGHT, BULLET_VELOCITY_MAGNITUDE, PI, TILE_SIDE_LENGTH, BULLET_RADIUS
...
class Tower(TowerInfo):
    ...
    def bullet_velocity(self) -> tuple[float, float]:
    ...
    def shoot(self, direction):
        bullet = Bullet(self.color, BULLET_RADIUS, self.screen_position(), self.bullet_velocity())
        bullet.initialize_bullet()
        self._bullets.append(bullet)
        self._remaining_seconds_to_shoot = 0.5

    def decrement_reload_time(self):
        self._remaining_seconds_to_shoot -= 0.5 / 30
